...
const stakeTRRXITTEV3PoolDeployer = '0xB0edb49557c583290368e04FffaBb293FC224Ae1';
const stakeTRRXITTEV3Factory = '0xC200B8E8eE9A4BFd22a2F31a3a64e581A3c9e793';
...
async function main() {
  ...
  await run(`verify:verify`, {
    ...
    constructorArguments: [
      stakeTRRXITTEV3PoolDeployer,
      stakeTRRXITTEV3Factory,
